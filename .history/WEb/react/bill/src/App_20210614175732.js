import "./App.css";
import { button, tab,table} from 'element-react';
          ...
          <el-tabs tab-position="left" type="" @tab-click="clickUserBill">
            <el-tab-pane label="查看账单">
              ...
              >
                ...
                <el-table-column prop="operation" label="收入/支出" width="100" :filters="[{text: '收入', value: true},{text: '支出', value: false}]"
                ...
                <el-table-column prop="date" sortable label="时间" width="180">
                </el-table-column>
            ...
            <el-tab-pane label="添加账单">
              ...
              <div class="content">
                <el-form ref="billForm" :model="billForm" label-width="80px" style="width: 400px;">
            ...
            <h1 class="title">{{item.user}}的账单</h1>
              ...
              >
                <el-table-column type="index" label="#" width="50"> </el-table-column>
                <el-table-column prop="operation" label="收入/支出" width="100">
                  <template slot-scope="scope">
                    <el-tag :type="scope.row.operation?'success':'danger'"
        ...
        <el-tab-pane label="可视化">
          <el-tabs tab-position="left" @tab-click="clickEchart">
            ...
            <el-tab-pane label="日历">
              ...
              <div class="content">
                <div id="calendarChar" style="width: 600px;height: 500px;"></div>
              </div>
            </el-tab-pane>
            <!-- 用户账单 -->
            <el-tab-pane
            ...
            <h1 class="title">#{{item.user}}的账单</h1>
              <div class="content">
                <div :class="'userChar'+'_'+item.user" style="width: 500px;height: 500px;"></div>
              </div>
            </el-tab-pane>
          </el-tabs>
        </el-tab-pane>
